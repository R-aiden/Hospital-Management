...
def Out():
    subprocess.Popen(["python","C:/Users/chava/Desktop/Hospital Management/Outbilling.py"])
def In():
    subprocess.Popen(["python","C:/Users/chava/Desktop/Hospital Management/Inbilling.py"])
