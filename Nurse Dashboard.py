...
username = sys.argv[1]
nurse_data = db.retrieve_nurse(username)
...
welcome_lable = ct.CTkLabel(root, text = "Welcome {}!".format(name),text_color = "Black",font=("TkinterDefaultFont",80),bg_color="snow2")
...
def show():
    ...
    if nurse_data:
        e_id_val,name_val,salary_val,dob_val,phone_val,user_id,pass_id,email_val,gender_val = nurse_data
...
#buttons
btn_details = ct.CTkButton(sidebar, text="Details", command = show,text_color="black", fg_color=button_color, hover_color=hover_color, corner_radius=10, font=ct.CTkFont(size=17))
